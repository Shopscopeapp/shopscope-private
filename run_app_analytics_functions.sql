-- Run this SQL script in your Supabase SQL editor to create the required functions
...
-- Test the functions
SELECT 'Daily Active Users Today:' as metric, get_daily_active_users(CURRENT_DATE) as value
UNION ALL
SELECT 'User Retention (7+ days):' as metric, get_user_retention() as value
UNION ALL
SELECT 'Conversion Rate (%):' as metric, get_conversion_rate() as value
UNION ALL
SELECT 'Wishlist Conversion (%):' as metric, get_wishlist_conversion_rate() as value;
